...
export default function Home() {
  ...
  useEffect(() => { document.title = 'Landbrugsmaskiner.dk — Kvalitet, Kompetence, Service'; }, []);
  ...
  const heroCategories = [
    { title: 'Landbrugsmaskiner', desc: 'Traktorer, mejetærskere og meget mere', image: '/images/minigraver.jpg', href: '/maskiner/landbrugsmaskiner' },
    { title: 'Brugte maskiner', desc: 'Stort udvalg af brugte maskiner — klar til levering', image: machines[0]?.pictures?.[0]?.url || '/images/hero.jpg', href: '/maskiner' },
    { title: 'Værksted & service', desc: 'Reparation og vedligeholdelse af landbrugsmaskiner', image: '/images/vaerksted.jpg', href: '/' },
  ];
    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <section className="pt-6 pb-20 lg:pb-28">
        <div className="max-w-[1260px] mx-auto px-5 sm:px-6">
          <Reveal>
            <div className="mb-10">
              <p className="text-[#51af37] text-[13px] font-semibold tracking-[0.2em] uppercase mb-2">Kategorier</p>
        ...
        <div className="max-w-[1260px] mx-auto px-5 sm:px-6">
          <Reveal>
            <div className="flex items-end justify-between mb-10">
              ...
              <Link href="/maskiner" className="text-[15px] font-medium text-[#51af37] hover:text-[#469e2f] flex items-center gap-1.5 transition-colors group">
      ...
      <section className="py-20 lg:py-28 bg-[#F5F5F3]">
        <div className="max-w-[1260px] mx-auto px-5 sm:px-6">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <Reveal delay={150}>
              <div>
                <p className="text-[#51af37] text-[13px] font-semibold tracking-[0.2em] uppercase mb-3">Om Landbrugsmaskiner.dk</p>
                <h2 className="text-[32px] lg:text-[40px] font-bold text-[#1a1a1a] mb-6 leading-tight">
                  Mere end 50 års erfaring<br />med maskiner
                </h2>
