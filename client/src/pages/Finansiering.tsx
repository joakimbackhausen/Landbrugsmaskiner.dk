        ...
        <section className="py-24 lg:py-32">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <p className="text-lg lg:text-xl text-muted-foreground leading-relaxed mb-8">
              Vi hjælper gerne med formidling af finansiering på både nye og brugte
              landbrugsmaskiner. Vi fører bl.a. Deutz-Fahr, Zetor, Maschio og mange andre mærker.
            </p>
            <p className="text-lg lg:text-xl text-muted-foreground leading-relaxed">
              Kontakt os for at høre mere om mulighederne for leasing og finansiering
            ...
            <div className="bg-[#2a3a47] text-white rounded-2xl p-10 lg:p-16 text-center shadow-2xl">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-8">
                ...
                >
                  ...
                  <span>86 37 92 68</span>
                </a>
                <a
                  href="mailto:lbb@landbrugsmaskiner.dk"
                  className="flex items-center gap-3 text-lg text-white/90 hover:text-white transition-colors"
                >
                  <Mail className="h-5 w-5" />
                  <span>lbb@landbrugsmaskiner.dk</span>
                </a>
              </div>
            </div>
          </div>
