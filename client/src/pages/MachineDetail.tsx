    ...
    return (
      <div className="min-h-screen flex flex-col bg-[#f5f5f5]">
        ...
        <main className="flex-1 flex items-center justify-center pt-20 lg:pt-[124px]">
          <Loader2 className="w-10 h-10 animate-spin text-[#51af37]" />
        </main>
        <Footer />
      </div>
    );
        ...
        <div className="max-w-[1224px] mx-auto px-5 sm:px-8 py-8 lg:py-12">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="space-y-6">
              ...
              <div>
                {categoryPath && (
                  <p className="text-[13px] text-[#1a1a1a] font-semibold tracking-wide uppercase mb-2">
                    {categoryPath}
                  </p>
                )}
              ...
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                ...
                <div className="text-[38px] font-bold text-[#1a1a1a] leading-tight mb-1">
              ...
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <a href="tel:+4586379268" className="flex-1">
                    <button className="w-full inline-flex items-center justify-center gap-2 bg-[#51af37] text-[#1a1a1a] text-[14px] font-semibold px-6 py-3 rounded-full hover:bg-[#e6da00] transition-colors">
          ...
          <div className="mt-10 lg:mt-14 space-y-4">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                <SpecItem label="Forhandler" value="Landbrugsmaskiner.dk" />
                <SpecItem label="Kontaktperson" value={machine.contact || 'Leif Birkballe'} />
                <SpecItem label="Adresse" value={machine.address || 'Mørkevej 8, DK-8410 Thorsager'} />
                <SpecItem label="Telefon" value="86 37 92 68" />
                <SpecItem label="Email" value="lbb@landbrugsmaskiner.dk" />
              </div>
            </div>
          </div>
        </div>
